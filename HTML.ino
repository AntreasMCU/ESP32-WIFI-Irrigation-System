...
void page_upload(){
  ...
  if(!digitalRead(BuildIn_led))
    client.println("<a href=\"LED=ON\"><button class=\"pump_button_gray\" style=\"position:relative; top:20px;\">Start</button></a></div>");
  else
    client.println("<a href=\"LED=OFF\"><button class=\"pump_button_red\" style=\"position:relative; top:20px;\">Stop</button></a></div>");
